    ...
    <div id="wrapper" class="active">
        ...
        <div class="page-content inset">
            ...
            <div id="data_zakat" style='margin: 20px 20px 20px 20px;'>
                <?php
                $sql = "SELECT * FROM tb_pembayaran_zakat"; 
                $i = 1;
                if ($res = mysqli_query($koneksi, $sql)) { 
                    if (mysqli_num_rows($res) > 0) { 
                        ...
                        echo "<th scope='col' style='max-width: 150px;'>Bayar Zakat</th>";
                        echo "<th scope='col' style='max-width: 150px;'>Jumlah(Rp/Kg)</th>"; 
                        ...
                        while ($row = mysqli_fetch_array($res)) { 
                            ...
                            <button class='btn btn-primary glyphicon glyphicon-print' onclick="location.href='print.php?cetak_laporan=<?php echo $row['id_pembayaran'] ?>'"> Cetak</button>
                            </td>
                            </tbody></th></tr>
                        <?php }
                        echo "</table>"; 
